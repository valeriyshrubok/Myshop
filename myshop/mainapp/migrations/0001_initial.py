    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_price', models.DecimalField(decimal_places=2, default=0, max_digits=6, verbose_name='Общая цена')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('', 'Новый заказ'), ('in_progress', 'Заказ в обработке'), ('is_ready', 'Заказ готов'), ('completed', 'Заказ выполнен')], default='', max_length=100, verbose_name='Cтатус заказа')),
                ...
                ('order_data', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Дата получения заказа')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_price', models.DecimalField(decimal_places=2, max_digits=6, verbose_name='Общая цена')),
